...
contract TribeChief_0_0_1 {
    ...
    //config >>>>
    uint epoch = 4320; // block time 14s, 6171 block = 24H
    uint signerLimit = 15;
    uint volunteerLimit = 2000;
    //config <<<<
    ...
    function TribeChief_0_0_1(address[] genesisSigners, uint _epoch, uint _signerLimit, uint _volunteerLimit) public {
        ...
        if (len > 0) {
            ...
            // 0xf91cb4a4615edc7d3b30b6abfa9c105c93050cca
            address g1 = uint160(1422178858947898454408110963759916310469519150282);
