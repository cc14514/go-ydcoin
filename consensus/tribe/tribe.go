// Copyright 2018 The ydcoin Authors
package tribe
...
func (t *Tribe) GetPeriod(header *types.Header, signers []*Signer) (p uint64) {
	// 20 , 24 , 28(random add 0~4.5s)
	Main, Subs, Other := t.config.Period, t.config.Period+4, t.config.Period+8
