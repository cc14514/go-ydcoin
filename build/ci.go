...
import (
	...
	"github.com/cc14514/go-ydcoin/internal/build"
	"strconv"
)
...
func doInstall(cmdline []string) {
	...
	if v0 <= 1 && v1 < 9 && !strings.Contains(runtime.Version(), "devel") {
		...
		log.Println("ydcoin requires at least Go version 1.9 and cannot")
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/cc14514/go-ydcoin/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "--target", "ios", "--tags", "ios", "-v", "github.com/cc14514/go-ydcoin/mobile")
