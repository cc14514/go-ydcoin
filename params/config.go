...
var (
	MainnetGenesisHash = common.HexToHash("0xd3e80a96784fbeaf3f0a736687c5a79143178c6a936fa7b71bd6678e3ebef1f6") // enforce below configs on
	TestnetGenesisHash = common.HexToHash("0x22251e1eeb7e12321981346ee249c4da8f8dcd4de1817c4be488c6cd54a02710") // Testnet genesis hash to enforce below configs on
)

var (
	// MainnetChainConfig is the chain parameters to run a node on the main network.
	MainnetChainConfig = &ChainConfig{
		ChainId:         big.NewInt(201810),
		...
		Chief001Address: common.HexToAddress("0x7c116607450f0398bc876d9ceaa3fa67b43520ad"),
		NR001Block:      big.NewInt(2),
		Tribe:           &TribeConfig{},
	}

	// TestnetChainConfig contains the chain parameters to run a node on the Ropsten test network.
	TestnetChainConfig = &ChainConfig{
		ChainId:        big.NewInt(201809),
		HomesteadBlock: big.NewInt(0),
		DAOForkBlock:   nil,
		DAOForkSupport: true,
		EIP150Block:    nil,
